...
class PatternLearner:
    ...
    def __init__(self, output_dir='./output', checkpoint_file='./output/pattern_learning_checkpoint.json'):
        ...
        self.scraper = AmazonScraper(config, output_dir=output_dir)
    ...
    def run(self, start_from: int = 0, max_categories: int = None, products_per_category: int = 5):
        """
        Run pattern learning for all categories
        ...
        # Apply start_from and max_categories
        if start_from > 0:
        ...
        for idx, category in enumerate(categories_to_process, start_from + 1):
